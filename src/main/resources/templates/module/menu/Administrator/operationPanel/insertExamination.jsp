...
<section id="container">
    ...
    <div class="row">
        ...
        <div id="operationPanel"class="col-lg-9 main-chart">
            ...
            <form   action="${pageContext.servletContext.contextPath}/upInsertExamination   "
                    enctype="multipart/form-data" method="post" id="form0">
                <div class="content-panel" style="margin-top: 100px;">
                    <table class="table table-striped table-advance table-hover">
                        <thead>
                        <tr>
                            <th><i class="fa fa-bullhorn"></i>考试名称</th>
                            <th class="hidden-phone">
                                <i class="fa fa-bullhorn"></i>
                                考试时间</th>
                            <th><i class="fa fa-bookmark"></i>监考老师</th>
                            <th></th>
                        </tr>
                        </thead>
                            <tbody>
                            <tr>
                                <th><span><input type="text" name="examinationName" /></span></th>
                                <th class="hidden-phone"><input type="date" id="start" name="examinationDate"></th>
                                <th><input type="text" name="teacherA" /></th>
                                <th><input type="text" name="teacherB" /></th>
                            </tr>
                            <tr >
                                <th colspan="3" ><textarea id="story" name="story"
                                                           rows="5" cols="33"style="height: 100px;width: 400px;resize: none;"
                                ></textarea><th/>
                                <th><button type="submit" class="btn btn-theme">提交</button></th>
                            </tr>
                            </tbody>
                    </table>
                </div>
