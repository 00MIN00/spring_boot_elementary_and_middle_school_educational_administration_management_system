        ...
        <div id="operationPanel"class="col-lg-9 main-chart">
                ...
                <div class="content-panel" style="margin-top: 100px;">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <!-- 遍历用户 -->
                        <tbody>
                        <form   action="${pageContext.servletContext.contextPath}/upInsertCourseraList"
                                enctype="multipart/form-data" method="post" id="form0">
                            <th colspan="3">
                                <input type="text" id="start" name="CourseraList">
                            </th>
                            <th colspan="2" style="width: 50px">
                                &nbsp<button type="submit" class="btn btn-theme">提交</button>
                            </th>
                        </form>
                        </tbody>
                    </table>
