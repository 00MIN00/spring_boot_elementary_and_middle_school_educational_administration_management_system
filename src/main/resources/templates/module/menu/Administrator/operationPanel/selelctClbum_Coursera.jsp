...
<%--                        行遍历--%>
                        <c:forEach items="${courseUidList_List_Map}" var="courseUidList_Map">
<%--                            列遍历--%>
                        <tbody style="background-color:#ffffff;margin: 5px 5px 5px 5px;padding:  10px 10px 10px 10px;">
                            <c:forEach items="${courseUidList_Map}" var="courseUid_Map">
                                <th>
                                    <span>${courseUid_Map.course}</span><br/>
                                    <span><c:if test="${courseUid_Map.teacher!='0'}">任课老师：${courseUid_Map.teacher}</c:if></span>
                                </th>
                            </c:forEach>
