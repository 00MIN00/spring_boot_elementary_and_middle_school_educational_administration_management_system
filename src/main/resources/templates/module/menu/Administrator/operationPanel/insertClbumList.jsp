...
<section id="container">
    ...
    <div class="row">
        ...
        <div id="operationPanel"class="col-lg-9 main-chart">
            ...
            <!-- 展示主体 -->
                <form   action="${pageContext.servletContext.contextPath}/upInsertNewClbumList"
                ...
                <div class="content-panel" style="margin-top: 100px;">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <!-- 遍历用户 -->
                        <tbody>
                        <th><span><input type="text" name="className"> </span></th>
                        <th><span>
                        ...
                        <th><span>
                            <select name="courseUid" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                <option selected value="0" > 暂未分配课程表</option>
