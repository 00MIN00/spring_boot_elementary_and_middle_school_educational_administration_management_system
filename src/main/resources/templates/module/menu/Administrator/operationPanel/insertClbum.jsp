...
<section id="container">
    ...
    <div class="row">
        ...
        <div id="operationPanel"class="col-lg-9 main-chart">
            ...
            <!-- 展示主体 -->
                <form   action="${pageContext.servletContext.contextPath}/upInsertClbum"
                        ...
                        <c:forEach var="Y" begin="1" end="10" step="1">
                            <tr>
                                <c:forEach var="X" begin="1" end="5" step="1">
                                    ...
                                    <th>
                                        <select  id="student_${Y}_${X}"name="student_${Y}_${X}" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                            <option selected value="0" ></option>

                                            <c:forEach items="${studentList}" var="student">
                                                    <option value="${student.uid}">${student.studentName}</option>
                                            </c:forEach>
                                        </select><br/>
                                    </th>
                                </c:forEach>
