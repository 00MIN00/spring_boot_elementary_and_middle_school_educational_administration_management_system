        ...
        <div id="operationPanel"class="col-lg-9 main-chart">
                ...
                <div class="content-panel" style="margin-top: 100px;">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <!-- 遍历用户 -->
                        <tbody>
                            <th colspan="3">&nbsp<span>${teacher.courseUidName}</span></th>
                            <th colspan="2" style="width: 50px">
                            <input type="hidden" id="uid" value="${teacher.uid}"/>
                                <a href="${pageContext.servletContext.contextPath}/queryAllCoursera?courseUid=${teacher.uid}">
                                    <button type="button" class="btn btn-theme">查看</button>
                                </a>
                                <a href="${pageContext.servletContext.contextPath}/updateCoursera?courseUid=${teacher.uid}">
                                <button type="button" class="btn btn-theme">修改</button>
                                </a>
                                <a href="${pageContext.servletContext.contextPath}/deleteCoursera?courseUid=${teacher.uid}&jurisdiction=${newUser.jurisdiction}">
