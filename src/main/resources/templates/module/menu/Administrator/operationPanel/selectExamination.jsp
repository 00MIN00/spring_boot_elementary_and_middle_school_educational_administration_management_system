                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    <tr>
                        ...
                        <th class="hidden-phone">
                            ...
                            考试时间</th>
                        <th><i class="fa fa-bookmark"></i>监考老师A</th>
                        <th></th>
                        <th></th>
                        <th></th>
                    </tr>
                    ...
                    <tbody>
                    <tr>
                        <th><span>${userItem.examinationName}</span>
                        </th>
                        <th class="hidden-phone"><span><fmt:formatDate value="${userItem.examinationDate}" pattern="yyyy-mm-dd" /></span></th>
                        <th><span>${userItem.teacherA}</span> </th>
                        <th><span>${userItem.teacherB}</span> </th>
                    </tr>
                    <tr>

                        <th colspan="3"><span>${userItem.bz}</span> </th>
                        <th>
                            <c:if test="${newUser.jurisdiction<=10}">
                                <form id="setform2" class="form-inline" role="form"
                                      action="${pageContext.servletContext.contextPath}/deleteExamination">
